...
./cpcc set-file run:in.conf_path_array[0][0].conf cpc/test/lib/swarms/run_swarms/1.gro
./cpcc set-file run:in.conf_path_array[0][1].conf cpc/test/lib/swarms/run_swarms/2.gro
./cpcc set-file run:in.conf_path_array[0][2].conf cpc/test/lib/swarms/run_swarms/3.gro

# create the grompp_input object
./cpcc set-file run:in.grompp.mdp cpc/test/lib/swarms/run_swarms/minim.mdp
