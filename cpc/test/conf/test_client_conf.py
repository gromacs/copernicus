...
class TestClientConf(unittest.TestCase):
    
    
    def setUp(self):
        #check if the server conf dir exists 
        #remove it if it does
        self.confFile = 'client/client.conf'
    ...
    def test_init(self):
        ...
        conf = ClientConf(confdir = self.confDir)
        ...
        conf2 = ClientConf(confdir=self.confDir)  #creating a new  instance reinitiates the config and reads parameters from config file  
