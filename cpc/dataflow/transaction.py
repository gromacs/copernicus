    ...
    def getAffected(self, project, affectedInputAIs, affectedOutputAIs):
        """Get the affected items of this transaction
           ...
           affectedOutputAIs = a set of active instances that will be 
                               ...
                               inputs generated by this change.  """
        pass
    def run(self, project, outf=None):
...
class Set(TransactionItem):
    ...
    def __init__(self, instance, oldVal, newVal):
    ...
    def getAffected(self, project, affectedInputAIs, affectedOutputAIs):
        """Get the affected items of this transaction"""
        self.instance.getNamedInputAffectedAIs(self.oldVal, self.newVal, 
                                               affectedInputAIs)

    def run(self, project, outf=None):
        """Run the transaction item."""
        self.instance.setNamedInput(self.oldVal, self.newVal)
        if outf is not None:
            outf.write("Set %s:%s to %s\n"%(self.instance.getCanonicalName(),
...
class Connect(TransactionItem):
    ...
    def getAffected(self, project, affectedInputAIs, affectedOutputAIs):
        ...
        # at the same time.
        project.active.addConnection(self.connection, affectedInputAIs, 
                                     affectedOutputAIs) 
