...
class ClientConf(Conf):
    ...
    '''
    __shared_state = {}
    CN_ID = "client"  #used to distinguish common names in certs
    def __init__(self,conffile='client.conf',confdir=None,reload=False):
        ...
        self._add("conf_dir",os.path.join(self.get("conf_dir"),"client"), 'The configuration directory',
                  userSettable=True)
