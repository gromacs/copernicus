...
if [ ! -e test/lib/fe/add_restraints/grompp.mdp ]; then
...
./cpcc set-file addres:in.grompp.top test/lib/fe/topol.top
./cpcc set-file addres:in.grompp.include[0]  test/lib/fe/ana.itp
./cpcc set-file addres:in.grompp.mdp test/lib/fe/grompp.mdp

./cpcc set-file addres:in.conf test/lib/fe/conf.gro
